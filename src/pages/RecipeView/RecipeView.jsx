...
function RecipeView() {
  ...
  useEffect(() => {
    if(!selectedRecipeUri) return;
    commonRecipeApi(selectedRecipeUri).then((res) => {
    selcetedRecipeRef.current = res.data;
    console.log(selcetedRecipeRef, "selcetedRecipeRefselcetedRecipeRef");
    setIsLoading(false);
    })
  }, [selectedRecipeUri]);
  ...
  return (
    <div className="recipeview__container">
      ...
      <div className="recipeview__content">
        ...
        <div className="recipeview__detail">
          ...
          <div className="recipeview__detail-secondaryinfo">
            {" "}
            Cuisine: <span>
              {selcetedRecipeRef.current.recipe.cuisineType}
            </span>{" "}
          </div>
          <div className="recipeview__detail-secondaryinfo">
      ...
      <div className="recipeview__instruction">
        ...
        <a href={selcetedRecipeRef.current.recipe.url} target="blank">Cooking Instruction</a>
    </div>
      </div>
      </>
}
